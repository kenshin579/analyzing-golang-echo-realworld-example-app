...
```bash
➜ git clone https://github.com/kenshin579/analyzing-golang-echo-realworld-example-app.git
```

Or simply use the following command which will handle cloning the repo:

```bash
➜ go get -u -v github.com/kenshin579/analyzing-golang-echo-realworld-example-app
```

Switch to the repo folder

```bash
➜ cd $GOPATH/src/github.com/kenshin579/analyzing-golang-echo-realworld-example-app
```
